...
# ClimdexRR.plotMapTrend <- function(){
...
# ClimdexRR.plotMapYear <- function(){
...
# ClimdexRR.plotVarGraph <- function(){
...
# ClimdexRR.Display.MapsTrend <- function(){
# 	if(is.null(.cdtData$EnvData)) return(NULL)
# 	if(is.null(.cdtData$EnvData$output)) return(NULL)

# 	imgContainer <- CDT.Display.Map.inter(ClimdexRR.plotMapTrend, .cdtData$EnvData$tab$dataMapStat, 'Climdex-Trend-Map')
...
# 		if(xyid$plotTS){
# 			imgContainer1 <- CDT.Display.Graph(ClimdexRR.plotVarGraph, .cdtData$EnvData$tab$dataGraph, 'Climdex-Graph')
...
# ClimdexRR.Display.MapYear <- function(){
# 	if(is.null(.cdtData$EnvData)) return(NULL)
# 	if(is.null(.cdtData$EnvData$output)) return(NULL)
# 	imgContainer <- CDT.Display.Map.inter(ClimdexRR.plotMapYear, .cdtData$EnvData$tab$dataMapTS, 'Climdex-Yearly-Map')
