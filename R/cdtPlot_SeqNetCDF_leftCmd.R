...
PlotSeqNetCDFFilesCmd <- function(){
	...
	subfr1 <- bwTabScrollableFrame(cmd.tab1)
		...
		bt.nc.MapOpt <- ttkbutton(frameMap, text = .cdtEnv$tcl$lang$global[['button']][['4']], width = largeur4)
