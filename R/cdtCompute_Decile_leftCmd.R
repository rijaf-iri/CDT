...
DecilesCalcPanelCmd <- function(){
    ...
    subfr1 <- bwTabScrollableFrame(cmd.tab1)
        ...
        txt.SPIfreq <- tklabel(frameTscale, text = lang.dlg[['label']][['7']], anchor = 'e', justify = 'right')
        ...
        bt.BasePeriod <- ttkbutton(frameParams, text = lang.dlg[['button']][['2']], state = stateBasePeriod)
        ...
        tkgrid(frameTscale, row = 0, column = 0, sticky = 'we', columnspan = 2, padx = 1, pady = 1, ipadx = 1, ipady = 1)
        ...
        helpWidget(en.outSPI, lang.dlg[['tooltip']][['10']], lang.dlg[['status']][['10']])
        ...
        calculateBut <- ttkbutton(subfr1, text = lang.dlg[['button']][['3']])
    ...
    subfr2 <- bwTabScrollableFrame(cmd.tab2)
        ...
        chk.dataIdx <- tkcheckbutton(frameDataExist, variable = decileDataExist, text = lang.dlg[['checkbutton']][['2']], anchor = 'w', justify = 'left')
    ...
    set.Data.Scales <- function(){
        ...
        tsc <- stringr::str_pad(substr(spi.tscales, 8, nch - 3), 2, pad = "0")
