...
qcTTOutlierCheckPanelCmd <- function(){
    ...
    subfr1 <- bwTabScrollableFrame(cmd.tab1)
        ...
        txt.INfile1 <- lang.dlg[['label']][['3-2']]
        txt.INfile2 <- lang.dlg[['label']][['3-3']]
        ...
        tkgrid(bt.infile1, row = 2, column = 4, sticky = 'we', rowspan = 1, columnspan = 1, padx = 0, ipadx = 1)
        ...
        tkgrid(bt.infile2, row = 4, column = 4, sticky = 'we', rowspan = 1, columnspan = 1, padx = 0, ipadx = 1)

        ###########
        helpWidget(cb.infile1, lang.dlg[['tooltip']][['2-1']], lang.dlg[['status']][['2-1']])
        helpWidget(bt.infile1, lang.dlg[['tooltip']][['3']], lang.dlg[['status']][['3']])
        helpWidget(cb.infile2, lang.dlg[['tooltip']][['2-2']], lang.dlg[['status']][['2-2']])
        helpWidget(bt.infile2, lang.dlg[['tooltip']][['3']], lang.dlg[['status']][['3']])
        ...
        tkbind(rb.vartxtn2, "<Button-1>", function(){
            ...
            helpWidget(cb.infile2, lang.dlg[['tooltip']][['2-1']], lang.dlg[['status']][['2-1']])
            helpWidget(cb.infile1, lang.dlg[['tooltip']][['2-2']], lang.dlg[['status']][['2-2']])
        })
