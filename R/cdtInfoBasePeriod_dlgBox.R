...
getInfoBasePeriod <- function(parent.win, Parameters)
{
	...
	chk.allYears <- tkcheckbutton(frBaseP, variable = allYears, text =  "Use all years from the input data", anchor = 'w', justify = 'left')
	...
	infobulle(en.startYear, "Enter the start year of the period")
	status.bar.display(en.startYear, "Enter the start year of the period")
	infobulle(en.endYear, "Enter the end year of the period")
	status.bar.display(en.endYear, "Enter the end year of the period")
	infobulle(en.minYear, "Enter the minimum number of years without missing values required for computation")
	status.bar.display(en.minYear, "Enter the minimum number of years without missing values required for computation")
