...
selectCDTData_getParams <- function(){
	...
	tkgrid(btStnfl2, row = 3, column = 9, sticky = 'w', rowspan = 1, columnspan = 1, padx = 0, pady = 0, ipadx = 1, ipady = 1)

	tkgrid(sep.filter1, row = 4, column = 0, sticky = 'we', rowspan = 1, columnspan = 10, padx = 1, pady = 1, ipadx = 1, ipady = 1)

	tkgrid(txtFilter1, row = 5, column = 0, sticky = 'we', rowspan = 1, columnspan = 4, padx = 1, pady = 0, ipadx = 1, ipady = 1)
	tkgrid(txtFilter2, row = 5, column = 4, sticky = 'we', rowspan = 1, columnspan = 3, padx = 0, pady = 0, ipadx = 1, ipady = 1)
	tkgrid(cbFilter, row = 5, column = 7, sticky = 'e', rowspan = 1, columnspan = 1, padx = 0, pady = 0, ipadx = 1, ipady = 1)
	tkgrid(enFilter, row = 5, column = 8, sticky = 'e', rowspan = 1, columnspan = 1, padx = 0, pady = 0, ipadx = 1, ipady = 1)
	tkgrid(txtFilter3, row = 5, column = 9, sticky = 'w', rowspan = 1, columnspan = 1, padx = 0, pady = 0, ipadx = 1, ipady = 1)
	...
	tkgrid(btFileSave, row = 8, column = 9, sticky = 'w', rowspan = 1, columnspan = 1, padx = 0, pady = 0, ipadx = 1, ipady = 1)
	...
	tkconfigure(bt.prm.OK, command = function(){
		if(str_trim(tclvalue(file.stnfl1)) %in% c("", "NA")){
			...
			tkmessageBox(message = lang.dlg[['message']][['8']], icon = "warning", type = "ok")
			tkwait.window(tt)
		}else{
